...
// Protege HTML sensibles antes de servir estáticos
const PROTEGIDOS = new Set(['/inicio.html', '/historial.html']);
app.use((req, res, next) => {
  if ((req.method === 'GET' || req.method === 'HEAD') && PROTEGIDOS.has(req.path)) {
